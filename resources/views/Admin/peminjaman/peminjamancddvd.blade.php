    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Peminjaman (30)</h3>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahPeminjamanLabel">Tambah Peminajaman</h5>
            ...
            <div class="modal-body">
                ...
                @include ('admin.modal.peminjamancddvd')
            </div>
