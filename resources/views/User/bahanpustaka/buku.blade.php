...
<div class="title-container">
    ...
    <div style="position: relative;">
        <hr style="height: 4px; 
            ...
            border-radius: 20px;
            width: 17%;">
        <select class="form-select" aria-label="Default select example" style="width: 15%; border-radius: 20px; border:2px solid grey; position: absolute; right: 250px; top: -30px;">
            <option selected>Filter Buku</option>
            <option value="1">One</option>
            <option value="2">Two</option>
            <option value="3">Three</option>
        </select>
        <div class="input-group" style="width: 15%; border-radius: 20px; border:2px solid grey; position: absolute; right: 40px; top: -30px;">
    ...
    <div style="display: flex; flex-direction: row; justify-content: space-between; padding-left: 30px; padding-right: 30px; margin: 0;">
        <p style="font-family: 'Poppins', sans-serif; font-weight: 600; font-size: 14px;">Buku Terbaru Sejak 14 November 2023</p>
